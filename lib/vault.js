...
export function routePageFolder(vaultPath, layout, type) {
...
// ──────────────────────────────────────────────────────────────────────────────
export function renamePage(vaultPath, config, oldTitle, newTitle) {
    const layout = resolveLayout(vaultPath, config);
    ...
    if (!from)
        throw new Error(`not found: ${oldTitle}`);
...
export function deletePage(vaultPath, config, title) {
    const layout = resolveLayout(vaultPath, config);
